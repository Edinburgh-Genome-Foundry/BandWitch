...
latex_documents = [
  ('index', 'BandWitch.tex', u'BandWitch Documentation',
   u'Zulko', 'manual'),
]
...
man_pages = [
    ('index', 'BandWitch', u'PACKAGE_NAME Documentation',
     [u'Zulko'], 1)
]
...
texinfo_documents = [
  ('index', 'BandWitch', u'BandWitch Documentation',
   u'Zulko', 'BandWitch', 'One line description of project.',
   'Miscellaneous'),
]
